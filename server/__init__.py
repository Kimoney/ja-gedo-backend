...
import os
from server.routes import main, ai_chatbot_bp, upload_cv_bp, auto_fill_bp, match_bp
...
# from .routes import main
        ...
        app.register_blueprint(upload_cv_bp, url_prefix=f'{API_PREFIX}/upload_cv') 
        app.register_blueprint(auto_fill_bp, url_prefix=f'{API_PREFIX}/auto_fill') 
